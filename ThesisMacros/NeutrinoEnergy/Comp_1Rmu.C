void Comp_1Rmu() {
  ...
  T2K_NuE->GetYaxis()->SetRangeUser(0.,0.1);
  T2K_NuE->GetXaxis()->SetRangeUser(0.,30.);
  ...
  Canv->Print("NeutrinoEnergyDist_Comp_1Rmu_NuE.pdf");
  ...
  T2K_NuMu->GetYaxis()->SetRangeUser(0.,0.1);
  T2K_NuMu->GetXaxis()->SetRangeUser(0.,30.);
  ...
  Canv->Print("NeutrinoEnergyDist_Comp_1Rmu_NuMu.pdf");
