void Comp() {
  ...
  Hist = (TH1D*)Atm_File->Get("SubGeV-elike-0dcy_NuE_NuEB");
  FC_SubGeV_NuE = (TH1D*)Hist->Clone();
  Hist = (TH1D*)Atm_File->Get("SubGeV-elike-1dcy_NuE_NuEB");
  FC_SubGeV_NuE->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-0dcy_NuE_NuEB");
  FC_SubGeV_NuE->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-1dcy_NuE_NuEB");
  FC_SubGeV_NuE->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-2dcy_NuE_NuEB");
  FC_SubGeV_NuE->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-pi0like_NuE_NuEB");
  FC_SubGeV_NuE->Add(Hist);

  Hist = (TH1D*)Atm_File->Get("SubGeV-elike-0dcy_NuMu_NuMuB");
  FC_SubGeV_NuMu = (TH1D*)Hist->Clone();
  Hist = (TH1D*)Atm_File->Get("SubGeV-elike-1dcy_NuMu_NuMuB");
  FC_SubGeV_NuMu->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-0dcy_NuMu_NuMuB");
  FC_SubGeV_NuMu->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-1dcy_NuMu_NuMuB");
  FC_SubGeV_NuMu->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-mulike-2dcy_NuMu_NuMuB");
  FC_SubGeV_NuMu->Add(Hist);
  Hist = (TH1D*)Atm_File->Get("SubGeV-pi0like_NuMu_NuMuB");
  FC_SubGeV_NuMu->Add(Hist);

  Hist = (TH1D*)T2K_File->Get("FHC1Rmu-2020_NuE_NuEB");
  T2K_NuE = (TH1D*)Hist->Clone();
  Hist = (TH1D*)T2K_File->Get("RHC1Rmu-2020_NuE_NuEB");
  T2K_NuE->Add(Hist);
  Hist = (TH1D*)T2K_File->Get("FHC1Re-2020_NuE_NuEB");
  T2K_NuE->Add(Hist);
  Hist = (TH1D*)T2K_File->Get("RHC1Re-2020_NuE_NuEB");
  T2K_NuE->Add(Hist);
  Hist = (TH1D*)T2K_File->Get("FHCCC1pi-2020_NuE_NuEB");
  T2K_NuE->Add(Hist);
  
  Hist = (TH1D*)T2K_File->Get("FHC1Rmu-2020_NuMu_NuMuB");
  T2K_NuMu = (TH1D*)Hist->Clone();
  Hist = (TH1D*)T2K_File->Get("RHC1Rmu-2020_NuMu_NuMuB");
  T2K_NuMu->Add(Hist);
  Hist = (TH1D*)T2K_File->Get("FHC1Re-2020_NuMu_NuMuB");
  T2K_NuMu->Add(Hist);
  Hist = (TH1D*)T2K_File->Get("RHC1Re-2020_NuMu_NuMuB");
  T2K_NuMu->Add(Hist);
  ...
  FC_SubGeV_NuE->Draw("HIST");
  T2K_NuE->Draw("HIST SAME");
  ...
  Canv->Print("NeutrinoEnergyDist_Comp_NuE.pdf");
  ...
  FC_SubGeV_NuMu->Draw("HIST");
  T2K_NuMu->Draw("HIST SAME");
 
  TLegend* Leg2 = new TLegend(0.4,0.795-0.05,0.89,0.89-0.05);
  ...
  Canv->Print("NeutrinoEnergyDist_Comp_NuMu.pdf");
