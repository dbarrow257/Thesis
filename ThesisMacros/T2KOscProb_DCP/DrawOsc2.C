void DrawOsc2() {
  ...
  TH1D* H_NH_NuMu_x_NuE_0 = (TH1D*)File->Get("Osc_NH_0/NuMu_x_NuMu");
  TH1D* H_NH_NuMu_x_NuE_pPiDiv2 = (TH1D*)File->Get("Osc_NH_pPiDiv2/NuMu_x_NuMu");
  TH1D* H_NH_NuMu_x_NuE_pPi = (TH1D*)File->Get("Osc_NH_pPi/NuMu_x_NuMu");
  TH1D* H_NH_NuMu_x_NuE_mPiDiv2 = (TH1D*)File->Get("Osc_NH_mPiDiv2/NuMu_x_NuMu");
  ...
  H_NH_NuMu_x_NuE_0->SetTitle(";E_{#nu} (GeV);P(#nu_{#mu} #rightarrow #nu_{#mu})");
