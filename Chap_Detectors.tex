...
\begin{figure}[h]
  ...
  \end{subfigure}
    \caption{The Interactive Neutrino GRID on-axis Detector. 14 modules are arranged in a cross shape configuration, with the centre modules being directly aligned with the on-axis beam.}
