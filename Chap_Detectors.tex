...
As illustrated in \autoref{fig:T2KSKExp_T2K_ND280}, the ECal, FGD, P0D and TPC is enclosed within UA1 magnet. Originally designed for the NOMAD \cite{Vannucci2014} experiment and reconditioned for use in the T2K experiment \cite{cerncourier_2022}, the UA1 magnet provides a uniform horizontal magnetic field of \quickmath{0.2 \pm 2\times10^{-4} \text{T}}.

Built into the UA1 magnet, the side muon range detector (SMRD)\cite{Aoki2013} monitors high energy muons which leave the tracker region and permeate through the ECal. It additionally acts as a cosmic muon veto and trigger. 
