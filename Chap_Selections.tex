...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{Down-going atmospheric subGeV single-ring samples comparing an mean and error the of pre-fit and post-fit Monte predictions in Red and Blue, respectively. The magneta histogram illustrates the Monte Carlo prediction using the generated dial values. The black points illustrates the down-going data with statistical errors given.}
