...
The atmospheric event selection follows the official SK analysis presented in \autoref{Jiang2019-iw} and is documented below.
...
\finish{Purity of MGenue and MGenuebar samples?}
...
\finish{PC and Upmu sample definitions}
\finish{CosZ and Momentum binning}

The distribution of reconstructed lepton momentum and zenith angle for each atmospheric sample used within this analysis is illustrated in \autoref{fig:SelsAndSysts_AllSampleComparison}. 
