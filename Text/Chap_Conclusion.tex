...
The sensitivities of the beam-only and joint atmospheric-beam fit have also been compared at a set of known oscillation parameters which are CP-conserving and in the lower octant of \quickmath{\sin^{2}(\theta_{23})}. The joint analysis has a \quickmath{\sim 5\%} reduction in the width of the \quickmath{1\sigma} credible intervals, showing an improved ability to correctly select the known values compared to the beam-only analysis.
