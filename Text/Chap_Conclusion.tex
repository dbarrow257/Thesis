...
The sensitivities of the beam-only and joint atmospheric-fit have also been compared at a set of known oscillation parameters which are CP-conserving and in the lower octant of \quickmath{\sin^{2}(\theta_{23})}. 
