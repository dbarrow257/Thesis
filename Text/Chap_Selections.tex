...
There are seven individual blocks of systematics (\quickmath{N_{b} = 7}): oscillation parameters, beam flux systematics, atmospheric flux systematics, neutrino interaction systematics, near detector systematics, beam far detector systematics, and atmospheric far detector systematics. The number of parameters in the \quickmath{k^{th}} block is defined as \quickmath{n(k)}.
